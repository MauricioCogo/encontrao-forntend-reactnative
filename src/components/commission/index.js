            ...
            {expanded && (
                <View style={styles.details}>
                    {participants && participants.length > 0 ? (
                        ...
                        <Text style={styles.messageText}>Não foi possivel exibir os participantes, verifique a conexão com a internet!</Text> // Exibir uma mensagem quando não houver participantes
                    )}
                </View>
            )}
        </View>
